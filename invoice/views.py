...
def dashboard(request):
    ...
    paidInvoices = Invoice.objects.filter(status="Pagado").count()
...
def viewPDFInvoice(request, slug):
    ...
    # Get Client Settings
    p_settings = Client.objects.get(clientName=invoice.client.clientName)
...
def companySettings(request):
    company = Client.objects.get(clientName="")
