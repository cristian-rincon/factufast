...
urlpatterns = [
    ...
    path("product/<str:slug>/update", views.ProductUpdateView.as_view(), name="update_product"),
    path("product/<str:slug>/delete", views.ProductDeleteView.as_view(), name="delete_product"),
